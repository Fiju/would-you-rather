...
import {
  selectLoggedInUser,
  selectUserById,
  selectIsFetching as selectisFetchingUser
...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    user,
    author,
    isLoading: selectIsFetching(state) || selectisFetchingUser(state)
  };
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(({ question, user, author, saveAnswer, isLoading }) => {
                ...
                <>
                  <div
                    className={classnames({
                      [styles.selected]: question.optionOne.votes.includes(
                        user.id
                      )
                    })}
                  >
                  ...
                  <div
                    className={classnames({
                      [styles.selected]: question.optionTwo.votes.includes(
                        user.id
                      )
                    })}
                  >
